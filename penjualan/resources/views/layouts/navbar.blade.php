    ...
    <li class="nav-item dropdown no-arrow mx-1">
      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        ...
        <a class="dropdown-item d-flex align-items-center" href="#">
          ...
          <div>
            <div class="small text-gray-500">April 03, 2024</div>
            <span class="font-weight-bold">Dokumen Asli Supersemar telah ditemukan</span>
          </div>
        </a>
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="mr-3">
          ...
          <div>
            <div class="small text-gray-500">April 09, 2024</div>
            Xi Jinping Telah Mengirim uang Rp200,000,000 ke Nomor Rekening anda
          </div>
        </a>
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="mr-3">
          ...
          <div>
            <div class="small text-gray-500">April 15, 2024</div>
      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <a class="dropdown-item d-flex align-items-center" href="#">
          ...
          <div class="font-weight-bold">
            <div class="text-truncate">Ads Pemutih itu hoaks ketipu gua </div>
            <div class="small text-gray-500">Stella Stunner· 58m</div>
          </div>
        </a>
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="dropdown-list-image mr-3">
          ...
          <div>
            <div class="text-truncate">Login -1 ASAP</div>
            <div class="small text-gray-500">Albertus Neilsen · 1m</div>
          </div>
        </a>
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="dropdown-list-image mr-3">
          ...
          <div>
            <div class="text-truncate">Baterai gua low pinjem charg......</div>
            <div class="small text-gray-500">Ansen Sandi · 2d</div>
          </div>
        </a>
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="dropdown-list-image mr-3">
          ...
          <div>
            <div class="text-truncate">Harghhh Harghhh Harghhhh</div>
            <div class="small text-gray-500">Ishowspeed · 2w</div>
          </div>
        </a>
